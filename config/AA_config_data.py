...
ONTOLOGY_WRITE_PATH = BASE_PATH + 'RDF_ont/'
...
#             {'main_entity': 'SignificantAdverseDrugReactions', 'data_path': 'Data/Drug/significantAdverseDrugReactions', 'name_to_save': 'fda/significantAdverseDrugReactions'},
...
{'main_entity': 'KnownDrugs', 'data_path': 'Data/Drug/mechanismOfAction', 'name_to_save': 'knownDrugsAggregated'},
]
...
PREFIX_EXCLUDING_PREDICATES = ['name', 'id', 'text']
